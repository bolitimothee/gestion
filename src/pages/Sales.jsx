                ...
                <div className="form-section">
                  ...
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <span className="form-hint">Choisir le produit vendu</span>
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        required
                      />
                      <span className="form-hint">Nom du client</span>
                    </div>
                  </div>
                  ...
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        required
                      />
                      <span className="form-hint">Quantité vendue</span>
                    </div>
                ...
                <div className="form-section">
                  ...
                  <div className="form-group full-width">
                    ...
                    <textarea
                      ...
                      placeholder="Notes additionnelles sur la vente..."
